...
from yolov5.yolo import YOLO, YOLO_ONNX
...
def predict(img_path):
    ...
    #----------------------------------------------------------------------------------------------------------#
    test_interval   = 100
    fps_image_path  = "VOCdevkit\VOC2007\JPEGImages\\000.jpg"
    #-------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        try:
            ...
            r_image, top, bottom, left, right = yolo.detect_image(image, crop = crop, count=count)
            # r_image.show()
